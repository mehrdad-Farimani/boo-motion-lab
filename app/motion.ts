...
export const REST: Pose = { left: 8, right: 8, tilt: 32, turn: 0, lids: 88 };
export const JOINTS = [
 {key:'left',label:'Left hand',min:-25,max:115,unit:'°'},
 {key:'right',label:'Right hand',min:-25,max:115,unit:'°'},
 {key:'tilt',label:'Neck · tilt',min:-25,max:50,unit:'°'},
 {key:'turn',label:'Neck · turn',min:-65,max:65,unit:'°'},
...
export const PRESETS:Record<string,Frame[]> = {
 ...
 'Look around':[{pose:REST,duration:1.4},{pose:{...REST,lids:15,tilt:0,turn:-50},duration:2.5},{pose:{...REST,lids:15,tilt:0,turn:50},duration:2},{pose:REST,duration:1}],
