...
export const PLAY={rugRadius:1.05,rugTop:.01,tableWidth:.30,tableDepth:.12,tableHeight:.055,tableZ:.32,ballRadius:.025,ballMass:.03,ballX:.092,ballZ:.267,targetZ:.45,targetY:.28,dragLift:.12} as const;
